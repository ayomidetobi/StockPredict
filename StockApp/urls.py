...
from .Prediction.views import StockPredictionView,PredictedDataView
...
urlpatterns = [
    ...
    path('predict/<str:symbol>/', StockPredictionView.as_view(), name='predict_stock_prices_api'),
    path('predicted-data/<str:symbol>/', PredictedDataView.as_view(), name='get_predicted_data'),
